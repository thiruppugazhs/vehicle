...
export const DashboardView: React.FC = () => {
  ...
  return (
    <div className="space-y-6 text-left">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-base font-bold text-slate-900 mt-0.5">
                  {assignedTechnicianRepairs.length} Active Work Orders Assigned
                </h3>
                <p className="text-xs text-slate-500">
                  Update repair stages, add workshop labor notes, and record service milestones.
                </p>
              </div>
            </div>
      ...
      {/* Requirement 58: Optional Smart Insights (Real Database Calculations) */}
      <div className="space-y-2 text-left">
        <div className="flex items-center justify-between">
          <h3 className="text-xs font-bold text-slate-900 flex items-center gap-1.5 uppercase tracking-wider">
            <Sparkles className="w-3.5 h-3.5 text-amber-500" />
            AI & Fleet Smart Insights
          </h3>
          <span className="text-[11px] font-medium text-slate-400">Live Database Insights</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {smartInsights.map(insight => (
            <div
              ...
              className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs hover:border-amber-300 hover:shadow-xs transition-all cursor-pointer flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between gap-2 mb-1.5">
                  <span className="font-bold text-xs text-slate-900 line-clamp-1">{insight.title}</span>
                  {insight.metric && (
                    <span className="px-2 py-0.5 bg-amber-50 text-amber-900 border border-amber-200 rounded-md font-bold text-[10px]">
                      {insight.metric}
                    </span>
                  )}
                </div>
