...
exports.unregisterDeviceToken = exports.registerDeviceToken = exports.onRepairCompleted = exports.onRepairCreated = exports.checkDocumentExpiryScheduled = exports.checkServiceRemindersScheduled = void 0;
 ...
 */
async function sendPushNotification(userIds, orgId, payload) {
...
// -----------------------------------------------------------------------------
exports.checkServiceRemindersScheduled = functions.pubsub
...
// -----------------------------------------------------------------------------
exports.checkDocumentExpiryScheduled = functions.pubsub
    .schedule('every 24 hours')
    .timeZone('UTC')
    .onRun(async () => {
    const now = new Date();
...
// -----------------------------------------------------------------------------
exports.onRepairCreated = functions.firestore
...
// -----------------------------------------------------------------------------
exports.onRepairCompleted = functions.firestore
    .document('repair_tickets/{ticketId}')
